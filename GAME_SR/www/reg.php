...
<pre>';
$VIP = Vipolnit_ssript($Nic,$parol,$povtorparol,$mail,$dir,$FNic,$Age,$pol,$logo,$data);
print '<br><font face="Comic Sans MS" point-size="7">Со всеми вопреосами обрашаться по адресу <a href="ilx666@mail.ru"><font color="#0000ff">ilx666@mail.ru</font></a></font></pre>
	</td>	</tr>
</table>
</body>';
$Consol=ob_get_contents();
ob_clean();
}
$forma = '
<body bgcolor="#DEE2EB">
...
<input  type="Hidden" name="Reg[delay]" value="Delay" >
	Ник* <input type="Text" name="Reg[Nic]" maxlength="20" value="'. rand (1,9999999999999).'"><br><br>
	Пароль* <input type="Password" name="Reg[Login]" maxlength="30" value="'. ($ra=rand (1,9999999999999)).'"><br><br>
	Еше раз* <input type="Password" name="Reg[Loginp]"maxlength="30" value="'.$ra.'"><br><br>
	E-mail* <input type="Text" name="Reg[mail]"maxlength="30" value="'. rand (1,9999999999999).'@'.rand (1,9999).'.ru"><br><br>
	Укажите пол <select size="1" name="Reg[pol]">
									<option value="men" >Мужской</option>
									<option value="women">Женский</option>
								  </select>
	&nbsp;&nbsp;&nbsp;&nbsp;Возраст <input type="Text" size="2" name="Reg[Age]" maxlength="2"  value="'.rand (6,99).'"><br><br>
