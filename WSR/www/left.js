...
function makeStatic(){
	...
	if (winY!=lastY&&winY>YOffset-staticYOffset){
		...
		if (YOffset-staticYOffset+lastY>YOffset-staticYOffset&&winY<=YOffset-staticYOffset){
...
function buildBar(){
	...
	document.write('<td align="center" rowspan="100" width="'+barWidth+'" valign="'+barVAlign+'" align=center height="272"><table cellpadding="0" cellspacing="0" border="0" width="23" height="100%" align="center"><tr><td background="images/centrNavR.gif" height="100%" align="center"><font face="'+barFontFamily+'" Size="'+barFontSize+'" COLOR="'+barFontColor+'"><B>'+tempBar+'<font color="#FFFFFF"><br>Ê<br>Ð<br>-<br><b style="color:Red;">1</b></font></B></font></td></tr></table></td>')
}
...
function buildMenu(){
	if (IE||NS6){
		document.write('<DIV ID="basessm" style="visibility: hidden; Position: Absolute; Left: '+XOffset+'; Top: '+YOffset+'; Z-Index: 20; width:'+(menuWidth+barWidth)+'"><DIV ID="thessm" style="Position: relative; Left: '+(-menuWidth)+'; Top: 0px; Z-Index: 21;'+((IE)?" width:0px":"")+'" onmouseover="moveOut()" onmouseout="moveBack()">')
	}
	if (NS){
	...
	if (NS6){
		document.write('<table border="0" cellpadding="0" cellspacing="0" width="'+(menuWidth+barWidth+2)+'"><TR><TD>')
	}
	document.write('<div align="right" style="width:'+(menuWidth+barWidth+2)+';background:transparent;"><img src="images/verxNavR-2.gif" width="23" height="49" alt=""></div>');
	...
	for (i=0;i<sI.length;i++){
		if (!sI[i][3]){
			...
			if (sI[i][3]!=menuCols) sI[i][5]=Math.round((menuWidth+6)*(sI[i][3]/menuCols)-1);
		...
		if (!sI[i][1]){
			...
			document.write('<TD Background="'+linkBGColor+'" WIDTH="'+sI[i][5]+'" COLSPAN="'+sI[i][3]+'"><ILAYER><LAYER onmouseover="bgColor=\''+linkOverBGColor+'\'" onmouseout="bgColor=\''+linkBGColor+'\'" WIDTH="100%" ALIGN="'+linkAlign+'"><DIV  ALIGN="'+linkAlign+'"><FONT face="'+linkFontFamily+'">&nbsp;<A HREF="'+sI[i][1]+'" target="'+sI[i][2]+'" CLASS="ssmItems" style="font-size:'+linkFontSize+';"">'+sI[i][0]+'</DIV></LAYER></ILAYER></TD>')
		}
	...
	if (IE||NS6){
		document.write('<div align="right" style="width:'+(menuWidth+barWidth+2)+'"><img src="images/nizNavR-2.gif" width="23" height="49" alt=""></div>');
