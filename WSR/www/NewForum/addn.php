...
?>
	<title>Добавление ответа! ::::: СВЧ и Мир КР ::::: Форум ::::: Союз Вольных Читеров и Мир Космических Рейнджеров <<==>> Форум</title>
...
<tr>
    ...
    <td background="bgF.gif"><h1 class="Tim">Ваше сообщение добавлено!</h1>
	<hr color="#77959F" size="1">
	<div align="center"><em class="fuz">Подождите несколко секунд.<br> Страница автоматически перейдет к теме.</em></div>
	<hr color="#77959F" size="1">
	<p></p>
<table align="center" cellspacing="10">
	<tr>
	<td><div align="center"><div class="text"><<<</div><div class="shadow" UNSELECTABLE="on"><<<</div></td>
	<td align="center" style="cursor:hand;"><a href='<?php echo ("Forum.php");?>' style="cursor:hand;"><em class="fuzzy">&nbsp;&nbsp;&nbsp;Перейти к списку тем&nbsp;&nbsp;&nbsp;</em></a><br><br><a href='<?php echo ("index.php?show=$no&f=$f&door=$ra");?>' style="cursor:hand;"><em class="fuzzy">&nbsp;&nbsp;&nbsp;Вернуться к теме&nbsp;&nbsp;&nbsp;</em></a></td>
