...
function P_line($x,$y,$X,$Y,$R,$a)
{
	...
	imagepolygon ($image,array($X,$Y,$p1[0],$p1[1],$x,$y,$p2[2],$p2[3]),4,rand(0x000000,0xffffff));//0
	...
	imagepolygon ($image,$p1,4,rand(0x000000,0xffffff));//1
	imagepolygon ($image,array($p4[0],$p4[1],$p1[4],$p1[5],$p1[2],$p1[3],$p2[0],$p1[3]),4,rand(0x000000,0xffffff));//2
