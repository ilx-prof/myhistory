...
<select name="func2" onchange="javascript:document.forms['forma2'].submit ( );">
			...
			<option value="one"  <? print $a=(isset ( $_POST["func2"] ) && $_POST["func1"] == "one" ? "selected" : "")?> > НОЛЬ </option>
			<option value="ty"    <? print $a=(isset ( $_POST["func2"] ) && $_POST["func1"] == "ty" ? "selected" : "")?> > Один </option>
</select>
</form>
<pre>
<?
