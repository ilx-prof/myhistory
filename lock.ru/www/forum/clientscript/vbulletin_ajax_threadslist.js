...
function vB_AJAX_OpenClose(obj)
{
	...
	*/
	this.toggle = function()
	{
		...
		this.xml_sender.send('ajax.php', 'do=updatethreadopen&t=' + this.threadid + '&src=' + PHP.urlencode(this.imgobj.src));
	}
...
|| # CVS: $RCSfile: vbulletin_ajax_threadslist.js,v $ - $Revision: 1.22 $
|| ####################################################################
\*======================================================================*/