	...
	if (AJAX_Compatible)
	{
		...
		*/
		this.name_search = function()
		{
			...
			this.xml_sender.send('ajax.php', 'do=usersearch&fragment=' + PHP.urlencode(this.fragment));
		}
		...
		*/
		this.menu_build = function()
		{
			...
			for (i in this.names)
			{
				...
				td.innerHTML = '<a href="#" onclick="' + this.varname + '.set_text(' + i + '); return false">' + this.names[i].replace(re, '<strong>$1</strong>') + '</a>';
			}
...
|| # CVS: $RCSfile: vbulletin_ajax_namesugg.js,v $ - $Revision: 1.16 $
|| ####################################################################
\*======================================================================*/