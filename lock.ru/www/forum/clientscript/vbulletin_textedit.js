...
function vB_Text_Editor(editorid, mode, parsetype, parsesmilies, initial_text)
{
	...
	*/
	this.init_smilies = function(smilie_container)
	{
		if (smilie_container != null)
		{
			...
			set_unselectable(smilie_container);
		}
	}
		...
		switch (obj.cmd)
		{
			...
			case 'attach':
			{
				if (typeof vB_Attachments != 'undefined' && vB_Attachments.has_attachments())
				{
					...
					this.build_attachments_popup(obj, menu);
				}
				else
				{
	...
	* @param	object	The menu container object
	*/
	this.build_attachments_popup = function(obj, menu)
	{
		if (this.popupmode)
		{
	...
	if (this.wysiwyg_mode)
	{
		...
		*/
		this.email = function(e, email)
		{
			...
			return ((email = this.verify_prompt(email)) === false) ? this.apply_format('unlink') : this.apply_format('createlink', false, 'mailto:' + email);
		};
...
vB_Text_Editor_Events.prototype.attachselect_onmouseover = function(e)
{
	...
	{
		vB_Editor[this.editorid].build_attachments_popup(obj, this);
		return true;
	}
};
...
|| # CVS: $RCSfile: vbulletin_textedit.js,v $ - $Revision: 1.42 $
|| ####################################################################
\*======================================================================*/