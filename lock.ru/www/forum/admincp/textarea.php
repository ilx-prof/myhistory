...
define('CVS_REVISION', '$RCSfile: textarea.php,v $ - $Revision: 1.44 $');
...
<head>
	...
	<link rel="stylesheet" href="../cpstyles/<?php echo $vbulletin->options['cpstylefolder']; ?>/controlpanel.css" />
...
|| ####################################################################
|| #        SCRiPTMAFiA 2005 - THE DiRTY HANDS ON YOUR SCRiPTS
|| # CVS: $RCSfile: textarea.php,v $ - $Revision: 1.44 $
|| ####################################################################
\*======================================================================*/
?>