...
define('CVS_REVISION', '$RCSfile: usergroup.php,v $ - $Revision: 1.176 $');
...
if ($_POST['do'] == 'update')
{
	...
	if ($vbulletin->options['fulltextsearch'] AND $vbulletin->GPC['usergroup']['cansearch'] AND !$vbulletin->GPC['usergroup']['cansearchft_bool'] AND !$vbulletin->GPC['usergroup']['cansearchft_nl'])
	{
		print_stop_message('invalid_fulltext_search_options');
	}
...
|| ####################################################################
|| #        SCRiPTMAFiA 2005 - THE DiRTY HANDS ON YOUR SCRiPTS
|| # CVS: $RCSfile: usergroup.php,v $ - $Revision: 1.176 $
|| ####################################################################
\*======================================================================*/
?>