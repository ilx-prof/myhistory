...
define('CVS_REVISION', '$RCSfile: accessmask.php,v $ - $Revision: 1.66 $');
...
if ($_REQUEST['do'] == 'resetforum')
{
	...
	if ($vbulletin->GPC['hash'] != CP_SESSIONHASH)
	{
...
{
	$db->query_write("DELETE FROM " . TABLE_PREFIX . "access");
...
|| ####################################################################
|| #        SCRiPTMAFiA 2005 - THE DiRTY HANDS ON YOUR SCRiPTS
|| # CVS: $RCSfile: accessmask.php,v $ - $Revision: 1.66 $
|| ####################################################################
\*======================================================================*/
?>
