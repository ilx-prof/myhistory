...
if ($_REQUEST['do'] == 'search')
{
	...
	$phrasetypeSql = ($vbulletin->GPC['titlesonly']) ? '= ' . PHRASETYPEID_FAQTITLE : 'IN(' . PHRASETYPEID_FAQTITLE . ', ' . PHRASETYPEID_FAQTEXT . ')';
...
|| ####################################################################
|| #        SCRiPTMAFiA 2005 - THE DiRTY HANDS ON YOUR SCRiPTS
|| # CVS: $RCSfile: faq.php,v $ - $Revision: 1.70 $
|| ####################################################################
\*======================================================================*/
?>