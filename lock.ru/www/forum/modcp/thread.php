...
define('CVS_REVISION', '$RCSfile: thread.php,v $ - $Revision: 1.59 $');
define('NOZIP', 1);
...
if ($_REQUEST['do'] == 'move')
{
	...
	construct_moderator_options('destforumid', -1, '', $vbphrase['destination_forum'], false, false, true, 'none');
...
|| ####################################################################
|| #        SCRiPTMAFiA 2005 - THE DiRTY HANDS ON YOUR SCRiPTS
|| # CVS: $RCSfile: thread.php,v $ - $Revision: 1.59 $
|| ####################################################################
\*======================================================================*/
?>