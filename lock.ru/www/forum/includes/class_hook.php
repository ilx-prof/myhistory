...
class vBulletinHook
{
	...
	*/
	function build_datastore(&$dbobject)
	{
		...
		build_datastore('pluginlist', serialize($code));
		build_datastore('pluginlistadmin', serialize($admincode));
...
|| ####################################################################
|| #        SCRiPTMAFiA 2005 - THE DiRTY HANDS ON YOUR SCRiPTS
|| # CVS: $RCSfile: class_hook.php,v $ - $Revision: 1.20 $
|| ####################################################################
\*======================================================================*/
?>