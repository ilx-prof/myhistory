...
class vB_DataManager_Poll extends vB_DataManager
{
	...
	*/
	var $validfields = array(
		...
		'voters'		=> array(TYPE_UNIT, REQ_NO),   # Default 0
		'public'		=> array(TYPE_UNIT, REQ_NO),   # Default 0
...
|| ####################################################################
|| #        SCRiPTMAFiA 2005 - THE DiRTY HANDS ON YOUR SCRiPTS
|| # CVS: $RCSfile: class_dm_poll.php,v $ - $Revision: 1.11 $
|| ####################################################################
\*======================================================================*/
?>