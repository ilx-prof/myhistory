...
function NamberIterac($x,$y)
{
	...
	{
		global $vih,$sir,$n,$DX,$DY,$min_y,$min_x,$max_Y,$max_X;//$cvet,$vih,$sir,$rand,$VINN,$image,$cvetmin,$cvetmax,$metod,$DX,$DY,$min_y,$min_x,$max_Y,$max_X;
